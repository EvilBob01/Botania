...
public class PatchouliUtils {
	...
	public static <T extends Recipe<C>, C extends RecipeInput> T getRecipe(Level level, RecipeType<T> type, ResourceLocation id) {
		...
		r = map.get(ResourceLocation.fromNamespaceAndPath("crafttweaker", id.getPath()));
		if (r != null) {
			return r;
		}
		r = map.get(ResourceLocation.fromNamespaceAndPath("crafttweaker", "autogenerated/" + id.getNamespace() + "." + id.getPath()));
		if (r != null) {
			return r;
		}
