...
public class MoltenCoreRodItem extends Item {
	...
	public void onUseTick(Level world, LivingEntity living, ItemStack stack, int time) {
		...
		if (pos.getType() == HitResult.Type.BLOCK) {
			...
			var smeltInput = new SingleRecipeInput(new ItemStack(state.getBlock()));
			world.getRecipeManager().getRecipeFor(RecipeType.SMELTING, smeltInput, p.level())
					.map(r -> r.value().assemble(smeltInput, world.registryAccess()))
