...
public class GreatFairyRingItem extends BaubleItem {
	...
	public Multimap<Holder<Attribute>, AttributeModifier> getEquippedAttributeModifiers(ItemStack stack) {
		...
		ret.put(PixieHandler.PIXIE_SPAWN_CHANCE_HOLDER, new AttributeModifier(ResourceLocation.fromNamespaceAndPath("botania", "great_fairy_ring_pixie_chance"), 0.25, AttributeModifier.Operation.ADD_VALUE));
		return ret;
	}
}
