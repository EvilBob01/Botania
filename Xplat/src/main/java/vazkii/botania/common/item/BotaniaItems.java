...
public final class BotaniaItems {
	...
	public static final Item recordGaia1 = make(prefix(LibItemNames.RECORD_GAIA1), new BotaniaRecordItem(1, Holder.direct(BotaniaSounds.gaiaMusic1), unstackable().rarity(Rarity.RARE), 202));
	public static final Item recordGaia2 = make(prefix(LibItemNames.RECORD_GAIA2), new BotaniaRecordItem(1, Holder.direct(BotaniaSounds.gaiaMusic2), unstackable().rarity(Rarity.RARE), 227));
