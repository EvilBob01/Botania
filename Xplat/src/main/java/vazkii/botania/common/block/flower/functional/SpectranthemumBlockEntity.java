...
public class SpectranthemumBlockEntity extends FunctionalFlowerBlockEntity {
	...
	public void tickFlower() {
		...
		if (!getLevel().isClientSide && redstoneSignal == 0 && getLevel().hasChunkAt(bindPos)) {
			...
			List<ItemEntity> items = getLevel().getEntitiesOfClass(ItemEntity.class, new AABB(pos.getX() - RANGE, pos.getY() - RANGE, pos.getZ() - RANGE, pos.getX() + RANGE + 2.0, pos.getY() + RANGE + 2.0, pos.getZ() + RANGE + 2.0));
