...
public class ItemModelProvider implements DataProvider {
	...
	private static final ModelTemplate GENERATED_1 = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath("minecraft", "item/generated")), Optional.empty(), TextureSlot.LAYER0, LAYER1);
	private static final ModelTemplate GENERATED_2 = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath("minecraft", "item/generated")), Optional.empty(), TextureSlot.LAYER0, LAYER1, LAYER2);
	private static final ModelTemplate HANDHELD_1 = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath("minecraft", "item/handheld")), Optional.empty(), TextureSlot.LAYER0, LAYER1);
	private static final ModelTemplate HANDHELD_3 = new ModelTemplate(Optional.of(ResourceLocation.fromNamespaceAndPath("minecraft", "item/handheld")), Optional.empty(), TextureSlot.LAYER0, LAYER1, LAYER2, LAYER3);
	...
	private static final ModelWithOverrides GENERATED_OVERRIDES = new ModelWithOverrides(ResourceLocation.fromNamespaceAndPath("minecraft", "item/generated"), TextureSlot.LAYER0);
	private static final ModelWithOverrides GENERATED_OVERRIDES_1 = new ModelWithOverrides(ResourceLocation.fromNamespaceAndPath("minecraft", "item/generated"), TextureSlot.LAYER0, LAYER1);
	private static final ModelWithOverrides HANDHELD_OVERRIDES = new ModelWithOverrides(ResourceLocation.fromNamespaceAndPath("minecraft", "item/handheld"), TextureSlot.LAYER0);
	private static final ModelWithOverrides HANDHELD_OVERRIDES_2 = new ModelWithOverrides(ResourceLocation.fromNamespaceAndPath("minecraft", "item/handheld"), TextureSlot.LAYER0, LAYER1, LAYER2);
